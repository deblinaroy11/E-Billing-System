    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php"><b>E- Electricity Billing System</b></a>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 signup">
                        ...
                        <p>Developed, designed, deployed, and maintained a network of federated sources that
contain Desktop-based application that offers a hassle-free billing experience and
satisfy customers by saving their time through the payment process, maintaining
records, and allowing the customer to view his/her records. This website at the end of its construction will act as a consumer oriented service for users for easy payment of their respective <b>Electricity Bill</b> as well as interact with their providers in case of any queries or grivances.</p>
                    </div>
                    <!-- /col-lg-6 -->
                    <div class="col-lg-6">
                        <h1> Sign Up </h1>
